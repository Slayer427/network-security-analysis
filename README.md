...
- DNS queries and HTTP traffic were successfully captured
- TLS handshake analysis confirmed encrypted communication

## 🧠 Learning Outcomes
- Understanding of network protocols (DNS, HTTP, TLS)
